...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        if (data.getType() == Message.MSG_TYPE_TEXT) {
            ...
            Log.e(TAG, "getView: " + data.getContent());
        ...
        Log.e(TAG, "------聊天页面头像url-----" + avatarUrl);
        Context mContext = holder.img_avatar.getContext();
        Glide.with(mContext)
                .load(avatarUrl)
                .centerCrop()
        ...
        switch (data.getState()) {
            case Message.MSG_STATE_FAIL:// 消息发送失败
                holder.progress.setVisibility(View.GONE);
                holder.img_sendfail.setVisibility(View.VISIBLE);
                break;
            case Message.MSG_STATE_SUCCESS:// 消息发送失败
                holder.progress.setVisibility(View.GONE);
                holder.img_sendfail.setVisibility(View.GONE);
                break;
            case Message.MSG_STATE_SENDING:// 消息正在发送
