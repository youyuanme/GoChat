...
public class JustDoSth extends VolleyPost {

	public JustDoSth(Context context, String url, Map<String, String> map) {
		...
		if (json != null) {
			try {
				...
				if ("true".equals(state)) {
					...
					getDataSuccessListener.onGetDataSuccess(url, null);
				}
