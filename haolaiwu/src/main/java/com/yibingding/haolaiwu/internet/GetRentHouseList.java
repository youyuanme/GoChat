...
public class GetRentHouseList extends VolleyPost {

	private List<HouseRentItem> houseRentItems = new ArrayList<HouseRentItem>();

	public GetRentHouseList(Context context, String url, Map<String, String> map) {
				...
				if ("true".equals(state)) {
					...
					for (int i = 0; i < array.length(); i++) {
						...
						String houseRentItemCommission = object_item
								.optString("t_RentalHouse_MoneyPlot");
